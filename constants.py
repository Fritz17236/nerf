...
NUM_RAY_SAMPLES = 16                # Number of samples to collect along each ray cast by querying the  network
...
RAY_CHUNK_SIZE = 1024               # Rays are passed through network in chunks (batches)  to prevent out-of-memory
